	...
	<div class="invoice_wrapper">
		<div class="header">
			...
			<div class="bill_total_wrap">
				<div class="bill_sec">
					<p>Bill To</p> 
	          		<p class="bold name">Jane Samer Pajela</p>
			        <span>
			           Kasiglahan, Hindi sad<br/>
			           +111 222345667
			        </span>
				</div>
				...
				<div class="table_body">
					<div class="row">
						...
						<div class="col col_des">
							<p class="bold">Mula Sayo, Para sa Bayan</p>
							<p>Likha - PUPQC Merch Tshirt</p>
						</div>
		...
		<div class="footer">
			...
			<div class="terms">
		        ...
		        <p>Bawal umutang, mag order ka kung may pambayad ka lang!</p>
		    </div>
		</div>
	</div>
</div>
